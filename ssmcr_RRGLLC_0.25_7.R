...
data11_<-read.csv("F:/ucl/pr/dataset/112/ngood/s41598-020-73558-3_sepsis_survival_study_cohort.csv",header = T)[1:500,]
data111112<-data11_[,4]
data111_<-rbind(data11_[data111112==1,],data11_[data111112==0,])
ran_start<- 12484445
set.seed(ran_start)
...
{set.seed(ran_seed)
  ...
  data11<-data1[,c(1:3,5:10)]
  data12<-data1[,4]
  a2=c(50,40,-75,-10)
  data1<-data1[data12==1|data12==0,]
  data11<-data1[,c(1:3,5:10)]
  data12<-data1[,4]
  data12[data12==0] <- -1
  data12[data12==1]<- 1
